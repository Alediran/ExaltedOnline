...
import { User, BoolModel } from "../core/model/data.model";
...
export class LoginComponent implements OnInit {
  ...
  account_validation_messages = {
    username: [
      ...
      },
      {
        type: "pattern",
        message:
          "Your username must start with three letters and contain only numbers or letters.",
      },
      {
        type: "ifUserExists",
    ...
    password: [
      ...
      {
        type: "maxlength",
        message: "Password cannot be more that 25 characters long.",
      },
      {
        type: "pattern",
        message:
  ...
  ifEmailExist(
    ...
    return this.apiService.emailExists(fc.value).pipe(
      map((res: BoolModel) => {
