...
#pragma warning restore CS1591
        ...
        public async Task<IActionResult> GetCharmsAsync(int pageSize = 10, int pageNumber = 1, int? lastEditedBy = null, int? colorID = null, int? outerPackageID = null, int? supplierID = null, int? unitPackageID = null)
        {
